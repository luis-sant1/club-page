...
export default function Events(props) {
    return (
        <div className="m-7 relative text-white ">
            ...
            alt="" />
            <div className="bg-[rgba(95,111,82,1)] absolute bottom-0 left-0 w-full text-white flex flex-wrap justify-center  group transition-all duration-300 hover:h-auto h-[50px]">
