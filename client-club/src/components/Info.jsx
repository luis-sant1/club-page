                ...
                <div className="w-11/12 mr-auto ml-auto" >
                    ...
                    <div ref={ref} className="pt-12 md:flex ">
                        <div className="border-b border-bottom-width: 1px; border-black border-solid pl-5 md:w-1/2 md:border-b-0 md:border-r md:pt-10 md:pr-10 lg:pl-14">
                            ...
                            <p className="text-lg font-light pb-7 lg:text-xl">Nuestra historia se remonta en el año 1932, cuando una asociación de líderes empresarios del país decidieron crear un lugar ideal en el cual pudieran pasar el tiempo junto a sus familias, y además, poder mostrarle al mundo su creativa forma de generar entretenimiento para todas las edades. Desde entonces, nos hemos enfocado en mejorar cada vez más, y ser cada vez más cercanos con nuestros socios, deseamos que nos des una oportunidad para mostrarte las maravillas de nuestro Club y su maravillosa historia. </p>
                        </div>
