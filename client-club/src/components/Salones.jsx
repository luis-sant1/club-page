    ...
    return(
        <div className="m-0 w-full h-full group md:pr-3 flex text-center">
            ...
            <div className="absolute z-10 hidden group-hover:block m-auto left-0 right-0 top-[40%] text-white " >
                ...
                <p 
                className=""><span className="text-lg relative after:bg-white after:absolute after:h-0.5 after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300 cursor-pointer">Ver mas</span></p>
